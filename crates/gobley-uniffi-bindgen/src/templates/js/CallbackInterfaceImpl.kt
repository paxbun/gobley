...
internal object {{ trait_impl }} {
    ...
    internal val {{ meth.name()|var_name }}: {{ ffi_callback.name()|ffi_callback_name }} =
        { {%- call kt::arg_list_ffi_decl(ffi_callback, 10) %} ->
    ...
    {%- endfor %}
    internal val uniffiFree: {{ "CallbackInterfaceFree"|ffi_callback_name }} =
        { handle: Long ->
